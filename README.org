...
Eval the following Emacs Lisp snippet to build the site.

#+begin_src emacs-lisp :exports both
(let* ((html-link-home "https://wip.jroi.dev/")
       ...
       (org-publish-project-alist `(("org"
                                    ...
                                    ("images"
                                     ...
                                     :base-extension any
                                     :publishing-directory "./www/images"
                                     :publishing-function org-publish-attachment
                                     :recursive t)
                                    ("feeds"
...
#+results:
: Last update: Sun Jul 19 13:30:58 2026
