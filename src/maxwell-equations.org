...
[[file:assets/maxwell-equations/page13.png]]
...
[[file:assets/maxwell-equations/mexp-sexp.png]]

As you can imagine, I could not resist to write my own implementation.
The following is the complete [[https://racket-lang.org/][Racket]] implementation ([[file:assets/maxwell-equations/evalquote.rkt][evalquote.rkt]]):

#+include: "assets/maxwell-equations/evalquote.rkt" src racket -n

And the following is the same Racket code after commenting every
single bit ([[file:assets/maxwell-equations/evalquote-commented.rkt][evalquote-commented.rkt]]):

#+include: "assets/maxwell-equations/evalquote-commented.rkt" src racket -n
...
passed from the environment ([[file:assets/maxwell-equations/evalquote-proc.rkt][evalquote-proc.rkt]]):
