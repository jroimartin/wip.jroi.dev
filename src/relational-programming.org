...
the relevant parts of the paper and is available [[file:assets/relational-programming/ukanren.ss][here]].

#+include: "assets/relational-programming/ukanren.ss" src scheme -n
...
[[file:assets/relational-programming/ukanren-usr.ss][here]].

#+include: "assets/relational-programming/ukanren-usr.ss" src scheme -n
