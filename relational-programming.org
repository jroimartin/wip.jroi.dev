...
#+RESULTS:
: ((((#(1) a b c) (#(0))) . 2) . #<procedure at ukanren.ss:3505>)
: ((((#(1) b c) (#(3)) (#(4) b c) (#(2) . a) (#(0) #(2) . #(3))) . 5) . #<procedure at ukanren.ss:3505>)
: ((((#(1) c) (#(6)) (#(7) c) (#(5) . b) (#(3) #(5) . #(6)) (#(4) b c) (#(2) . a) (#(0) #(2) . #(3))) . 8) . #<procedure at ukanren.ss:3505>)
...
#+begin_src scheme -n :scheme chez :session ukanren :exports both :results verbatim
  (load "relational-programming/ukanren.ss")
  (load "relational-programming/ukanren-usr.ss")
